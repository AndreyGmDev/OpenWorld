...
{
    /*[SerializeField, Tooltip("Os objetos dem estar na layer InteractableObjects.")] GameObject computers; // O computador na cena.
    [SerializeField, Tooltip("Precisam ter suas MeshRenderer ativadas para serem desativadas quando o player interagir com cada computador.")] GameObject screenComputers; // A tela do computador na cena.
